...
import networklab.smartapp.exception.UnauthorizedException;
...
public class AppController {
    ...
    public AppController(SmartAppDefinition smartAppDefinition,
            HttpVerificationService httpVerificationService, TokenRefreshService tokenRefreshService) {
...
//        if (executionRequest.getLifecycle() != AppLifecycle.CONFIRMATION
//                &&
//        if(!httpVerificationService.verify(request.getMethod(), request.getRequestURI(), headers)) {
